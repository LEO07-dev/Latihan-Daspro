...
//kamus
    int konsonan, vokal, i, kata, a;
    //jika ada spasi
    char ArrKalimat[200]; //tanpa input  //= "AKU CAH DINUS "; /* bisa juga ditulis */ //= {'A', 'K', 'U', ' ', 'C', 'A', 'H', ' ', 'D', 'I', 'N', 'U', 'S'};
...
//deskripsi
    ...
    {
        //coba gunakan input
        cout << "Kalimat    : "; cin.getline(ArrKalimat, 200);
        cout << "Masukkan jumlah karakter : ";cin >> a;
        strupr(ArrKalimat);
